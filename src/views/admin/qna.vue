<template>
  <div>
    <v-toolbar dense flat color="grey lighten-4">
      <v-toolbar-title class="pl-2">الاسئلة</v-toolbar-title>
      <v-spacer></v-spacer>
      <v-btn color="#55AB88" dark @click="rest()">اضافة سؤال</v-btn>
    </v-toolbar>
  ...
  data() {
    return {
      ...
      headers: [
        ...
        { text: "الجواب ", value: "shortAnswer" },
        // { text: " رابط الفيسبوك ", value: "answer" }
